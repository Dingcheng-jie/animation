...
def make_edge_smooth(dataset_name, img_size) :
    check_folder(os.getcwd()+'/datasets/{}/{}'.format(dataset_name, 'smooth'))
    file_list = glob(os.getcwd()+'/datasets/{}/{}/*.jpg'.format(dataset_name, 'style'))
    save_dir = os.getcwd()+'/datasets/{}/smooth'.format(dataset_name)
    kernel_size = 5
