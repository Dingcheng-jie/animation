...
class AnimeGANv2(object) :
    def __init__(self, sess, args):
        ...
        self.real_image_generator = ImageGenerator('./datasets/train_photo', self.img_size, self.batch_size)
#         self.real_image_generator = ImageGenerator('./datasets/{}'.format(self.dataset_name + '/train_256'), self.img_size, self.batch_size)
        self.anime_image_generator = ImageGenerator('./datasets/{}'.format(self.dataset_name + '/style'), self.img_size, self.batch_size)
        self.anime_smooth_generator = ImageGenerator('./datasets/{}'.format(self.dataset_name + '/smooth'), self.img_size, self.batch_size)
