...
import sys
sys.path.append("..") 
from AnimeGANv2.tools import generator as tf_generator
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--tf_checkpoint_path',
        type=str,
        default='../AnimeGANv2/checkpoint/generator_Summer_weight',
    )
    parser.add_argument(
        '--save_name', 
        type=str, 
        default='models/pytorch_generator_Summer.pt',
    )
